...
I prefer writing more integration tests than unit tests. I talk about the same
in
[Testing: Building application with confidence](https://balavishnuvj.com/blog/testing-building-application-with-confidence/).
While writing integration tests, you might have nested child component that is
...
from `axios` to `fetch` or to any new shiny library, I will have to
